...
assert(serviceWorkerText.includes('js/messkonzept/model.js') && !serviceWorkerText.includes('js/messkonzept/mieterstrom.js') && /beta\.322/.test(serviceWorkerText), 'service-worker.js: vereinfachter Modellstand muss im neuen Offline-Cache enthalten sein');
...
assert(indexText.includes('mk-start-group--mieterstrom') && indexText.includes('Mieterstromkonzept') && presetText.includes('mieterstrom-d1') && presetText.includes("group: 'mieterstrom'") && stylesText.includes('.mk-start-flow-chip--mieterstrom'), 'Mieterstrom: D1-Kategorie, Bordeaux-Akzent und Startkarte fehlen');
