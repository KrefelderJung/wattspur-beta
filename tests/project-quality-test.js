...
assert(presetText.includes("title: 'MKD1: Mieterstromgemeinschaft'") && presetText.includes("flow: ['PV', 'Mieterstromnutzer']") && messkonzeptText.includes("kinds.push('mieterstrom-user')") && stylesText.includes('--mk-chip-bg: transparent'), 'Mieterstrom: D1-Bezeichnung und semantischer Nutzerchip fehlen');
