...
assert(/export\.js\?v=28/.test(indexSource), 'Exportmodul muss mit neuem Cache-Buster geladen werden');
assert(/APP_VERSION\s*=\s*['"]2026\.09.03-beta\.385['"]/.test(workerSource), 'Service Worker muss den neuen Exportstand cachen');
