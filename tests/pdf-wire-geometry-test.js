...
assert(/export\.js\?v=29/.test(indexSource), 'Exportmodul muss mit neuem Cache-Buster geladen werden');
assert(/APP_VERSION\s*=\s*['"]2026\.09.06-beta\.386['"]/.test(workerSource), 'Service Worker muss den neuen Exportstand cachen');
