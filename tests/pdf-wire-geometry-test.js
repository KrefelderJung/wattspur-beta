...
assert(/export\.js\?v=10/.test(indexSource), 'Exportmodul muss mit neuem Cache-Buster geladen werden');
assert(/APP_VERSION\s*=\s*['"]2026\.08.23-beta\.366['"]/.test(workerSource), 'Service Worker muss den neuen Exportstand cachen');
