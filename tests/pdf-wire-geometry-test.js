...
assert(/export\.js\?v=19/.test(indexSource), 'Exportmodul muss mit neuem Cache-Buster geladen werden');
assert(/APP_VERSION\s*=\s*['"]2026\.08.25-beta\.376['"]/.test(workerSource), 'Service Worker muss den neuen Exportstand cachen');
