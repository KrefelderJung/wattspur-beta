...
if ((validation.innerHTML.match(/mk-validation-tag/g) || []).length !== 2) throw new Error('Jede Prüfkarte muss ihren Status als Badge anzeigen');
...
if (!validation.innerHTML.includes('mk-validation-tag info') || !validation.innerHTML.includes('mk-validation-tag warning')) throw new Error('Info- und Hinweis-Tags müssen als semantische Status-Pills gerendert werden');
