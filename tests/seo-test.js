...
assert(serviceWorker.includes("'lastgang-analyse.html'") && serviceWorker.includes("'messkonzept-konfigurator.html'") && /beta\.308/.test(serviceWorker), 'Offline-Cache: stabile SEO-Einstiegsseiten oder Versionsstand fehlen');
