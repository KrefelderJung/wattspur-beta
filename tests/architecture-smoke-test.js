...
const moduleContracts = [
    ...
    ['js/messkonzept/annotations.js', 'WattspurMesskonzeptAnnotations', 'createAnnotationController'],
    ['js/messkonzept/drag-drop.js', 'WattspurMesskonzeptDragDrop', 'createDragDrop'],
    ['js/messkonzept/pointer-drag.js', 'WattspurMesskonzeptPointerDrag', 'createPointerDragController'],
