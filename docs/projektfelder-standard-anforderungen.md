# Anforderungen: Standardisierte Projektfelder

## Ziel

Die Projektangaben sollen ruhig, verständlich und in allen Ansichten einheitlich
wirken. Sichtbare Feldbezeichnungen bleiben erhalten. Platzhalter dienen nur
als kurze Beispiele und ersetzen kein Label.
...
- Der Skizzeneditor steht im Arbeitsablauf vor den ergänzenden Projektangaben.
- Die Projektangaben stehen auf großen Bildschirmen direkt unter der Skizze und
  übernehmen symmetrisch die Breite des Editorbereichs. Palette und Hinweise
  bleiben davon getrennt.
- Kommentar ist ein fester Abschnitt innerhalb der Projektangaben und kein
  eigener Aufklappbereich.
...
6. Die Projektangaben erscheinen im DOM nach dem Skizzeneditor und innerhalb
   des Editorbereichs; Kommentar und Projektfelder werden gemeinsam über
   denselben Aufklappbereich erreicht.
