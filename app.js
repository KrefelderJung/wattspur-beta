    ...
    tabBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            if (targetTabId === 'tab-editor') {
                window.WattspurLastgangDataEditor?.loadTableValuesToEditor();
            }
...
function openDatasetsInDashboard(datasets, options = {}) {
    ...
    if (btnPrevPage) {
        btnPrevPage.addEventListener('click', () => {
            window.WattspurLastgangDataEditor?.previousPage();
        });
    }
    ...
    if (btnNextPage) {
        btnNextPage.addEventListener('click', () => {
            window.WattspurLastgangDataEditor?.nextPage();
        });
    }

    updateMetricButtonsVisibility();
    window.WattspurLastgangDataEditor?.setupSpreadsheetEvents();
}
...
function updateDashboard() {
    try {
        ...
        if (window.WattspurLastgangDataEditor && !window.WattspurLastgangDataEditor.isSaving()) {
            window.WattspurLastgangDataEditor.loadTableValuesToEditor();
        }
    } catch (error) {
