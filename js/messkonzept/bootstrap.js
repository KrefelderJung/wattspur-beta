...
(function exposeMesskonzeptBootstrap(global) {
    ...
    const SELECTORS = Object.freeze({
        ...
        objectModalAnnotationToggle: '#mk-object-annotation-toggle',
        objectModalAnnotationToggleInput: '#mk-object-annotation-toggle-input',
    ...
    function collectElements(documentRef = global.document) {
        ...
        return {
            ...
            objectModalAnnotationToggle: query(SELECTORS.objectModalAnnotationToggle),
            objectModalAnnotationToggleInput: query(SELECTORS.objectModalAnnotationToggleInput),
